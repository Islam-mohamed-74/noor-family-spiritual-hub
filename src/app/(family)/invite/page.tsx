...
export default function InvitePage() {
  ...
  const { data: inviteCode, isLoading: loading } = useQuery({
    queryKey: qk.inviteCode(user?.familyId ?? ""),
    queryFn: () => getInviteCode(user!.familyId),
  ...
  const joinUrl =
    inviteCode && origin ? `${origin}/join?code=${inviteCode}` : "";
